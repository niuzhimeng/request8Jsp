...
<%
  ...
  if(rs1.next()) currentWFCreater = Util.null2String(rs1.getString("resourceId"));
  ...
  String userpslinfo = HrmPaidSickManagement.getUserPaidSickInfo(""+currentWFCreater, currentdate);
      ...
      <td class="fieldvalueClass" class=field> 
        ...
        if(fieldhtmltype.equals("1") || fieldhtmltype.equals("2") ){  // 单行,多行文本框
			if(fieldname.equals("lastyearannualdays")) out.println(lastyearannual); 
				...
				if(showAnnualInfo) {%>
					<%=SystemEnv.getHtmlLabelName(21614,user.getLanguage())+"&nbsp;:&nbsp;"+lastyearannual%><br><%=SystemEnv.getHtmlLabelName(21615,user.getLanguage())+"&nbsp;:&nbsp;"+thisyearannual%><br><%=SystemEnv.getHtmlLabelName(21616,user.getLanguage())+"&nbsp;:&nbsp;"+allannual%>
				<%} else if(showPSLInfo) {%>
					<%=SystemEnv.getHtmlLabelName(24039,user.getLanguage())+"&nbsp;:&nbsp;"+lastyearpsldays%><br><%=SystemEnv.getHtmlLabelName(24040,user.getLanguage())+"&nbsp;:&nbsp;"+thisyearpsldays%><br><%=SystemEnv.getHtmlLabelName(24041,user.getLanguage())+"&nbsp;:&nbsp;"+allpsldays%>
