...
%>
					...
					<script type="text/javascript">
						jQuery(document).ready(function(){
							var detailbrowclick = "onShowBrowser2_fna('relaterequest_<%=recorderindex %>','"+browserUtl_req+"','','16','<%=ismand %>')";
            ...
            if( isedit != 1 ) {
                ...
                switch (dsporder)  {
					...
					case 10 :
                        ...
                        var detailbrowclick = "onShowBrowser2_fna('relaterequest_"+insertindex+"','"+browserUtl_req+"','','16','"+ismand+"')";
						...
						initE8Browser("relaterequest_"+insertindex, insertindex, ismand, "", "", detailbrowclick, "/data.jsp?type=workflowBrowser");
