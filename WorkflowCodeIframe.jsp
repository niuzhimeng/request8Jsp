...
if(operation.equals("CreateCodeAgain")){
	...
	if(reservedId>=1){
		if(codeSeqReservedId>=1){
		    ...
		    //if(!hisReservedIdList.contains(""+reservedId)){
		    	//hisReservedIdList.add(""+reservedId);
		    	RecordSet.executeSql("update workflow_codeSeqReserved set hasUsed='0',hasDeleted='0' where codeSeqId="+recordId);
		    	//String  reservedCode=WorkflowCodeSeqReservedManager.getReservedCode(workflowId,formId,isBill,recordId,-1,Integer.parseInt(hisReservedIdList.get(x)),createrdepartmentid);
		    	//reservedCode=Util.toHtml100(reservedCode);
		    	//System.out.println("sf reservedCode = "+reservedCode);
		    	//RecordSet.executeSql("insert into workflow_codeSeqReserved(codeSeqId,reservedId,reservedCode,reservedDesc,hasUsed,hasDeleted) values("+recordId+","+hisReservedIdList.get(x)+",'"+reservedCode+"','','0','0')");
		    //}
		}
	}
