			    		...
			    		<tr>       
						 ...
						 %>
                            <td id="signrighttool" style="position: relative; background-color: #fff;display:none;" valign="top">
                                ...
                                -->
                                <!-- 附加信息 -->
                                <div class="signotherblock" style="position: absolute; left: 0; top: 0px;bottom:0px;right:-1px; height:<%=formSignatureHeight%>px; background:#f8f8f8;border:1px solid #cccccc;border-top:0px solid #ccc;overflow-y:auto;overflow-x:hidden;">
                                     <%
