...
function addclass(obj,type){
	...
	if(type==0)
		...
		main_div_warp.leftFrame.location.href="left_invoice.jsp";
	else if(type==7)
		main_div_warp.leftFrame.location.href="left_crmInfo1.jsp";
}
</script>
            ...
            <%if(Customertype.equals("3") || Customertype.equals("4")){%>
             ...
             <td width='400' align="left">
              <%}%>
				...
				<%}%>
			    <div class="crm_menudiv"><div class="crm_menuitem" onclick="addclass(this,6)">发票</div></div>
			    <div class="crm_menudiv"><div class="crm_menuitem" onclick="addclass(this,7)" title="CRM">CRM</div></div>
			</td>
