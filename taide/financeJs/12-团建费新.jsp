...
<script type="text/javascript">
    var fpzd = 'field15574'; // 发票字段
    var sqr = 'field13291'; // 申请人
    var bhsje = 'field13297'; // 不含税金额

    // ===========明细表字段
    var fpid = 'field15576'; // 发票id
    var fph = 'field13329'; // 发票号
    var bhsjemx = 'field13332'; // 税额
    var jxs = 'field15577'; // 进项税
    var sl = 'field1331'; // 税率
