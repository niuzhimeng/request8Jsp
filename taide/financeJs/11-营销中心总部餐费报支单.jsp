...
<script type="text/javascript">
    var fpzd = 'field15623'; // 发票字段
    var sqr = 'field15622'; // 申请人
    var bhsje = 'field13113'; // 不含税金额

    // ===========明细表字段
    var fpid = 'field15626'; // 发票id
    var fph = 'field13161'; // 发票号
    var fpCode = 'field12157'; // 发票Code
    var bhsjemx = 'field13164'; // 税额
    var jxs = 'field15625'; // 进项税
    var sl = 'field13163'; // 税率
    var mxbNum1 = 'submitdtlid0'; // 明细表1（主）
    var mxbNum4 = 'submitdtlid2'; // 明细表4（次）
    $(function () {
        appendFpButton();
    ...
    function deleteLine(p) {
        ...
        if (newVal.length < oldVal.length) {
            ...
            $("input[name='check_node_2']").each(function () {
