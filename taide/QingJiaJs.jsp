<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        checkCustomize = function () {
            //以下是都有的
            var type = jQuery('#field19923').val(); //类型
            var sDate = jQuery('#field19201').val(); //开始日期
            var eDate = jQuery('#field19202').val(); //结束日期
            var sHour = jQuery('#field19925').val(); //开始小时
            var eHour = jQuery('#field19926').val(); //结束小时
            var sMinute = jQuery('#field19214').val(); //开始分钟
            var eMinute = jQuery('#field19215').val(); //结束分钟
            //以上是都有的
            ...
            if (type == "4") {
                if ((hour-0.5) % 4 != 0) {
                    window.top.Dialog.alert("年假必须是4小时的倍数");
                    return false;
                }
            }
