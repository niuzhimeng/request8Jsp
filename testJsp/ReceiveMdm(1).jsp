            ...
            if (jsonObject.get("Table").isJsonArray()) {
                ...
                for (POTableVo pOTableVo : pOTableVoList) {
                    ...
                    if ("1071".equals(btype)) {
                        //机构
                        List<OrganizationVo> voList = gson.fromJson(data, new TypeToken<List<OrganizationVo>>() {}.getType());
                        ...
                        //人员
                        List<PersonVo> voList = gson.fromJson(data, new TypeToken<List<PersonVo>>() {}.getType());
...
<%!
    ...
    private static void consumerData(String btype, String bdata) {
        ...
        if ("1067".equals(btype)) {
            ...
            List<CostCenterVo> costCenterVoList = gson.fromJson(bdata, new TypeToken<List<CostCenterVo>>() {}.getType());
            ...
            List<InternalOrderVo> internalOrderVoList = gson.fromJson(bdata, new TypeToken<List<InternalOrderVo>>() {}.getType());
            ...
            List<CompanyCodeVo> companyCodeVoList = gson.fromJson(bdata, new TypeToken<List<CompanyCodeVo>>() {}.getType());
