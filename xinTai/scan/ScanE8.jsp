...
<div class="wf-scanworkflow-content">
    <div class="wf-scanworkflow-title">请使用扫码枪扫描二维码</div>
    <div class="wf-scanworkflow-subTitle">注：系统只能识别对应流程ID的二维码</div>
    <div class="wf-scanworkflow-scanCode"><img src="/workflow/request/xinTai/images/code.png"></div>
    <div class="ant-tabs ant-tabs-top ant-tabs-card" style="width: 600px; margin: 0 auto">
        <input onclick="myClear()" id="myInput" type="text"
               value="" style="margin-left: 20px; margin-top: 10px; color: #848484; width: 570px; height: 30px;" autocomplete="off"/>
        <div class="wf-scanworkflow-tip">使用扫描枪扫描二维码可自动打开条码对应的流程</div>
    </div>
</div>
