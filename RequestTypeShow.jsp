...
rs.executeSql("select activeversionid,id,workflowtype from workflow_base t1 where  id in(" + selectedWfids + ") and (t1.activeversionid is null or exists (select 1 from workflow_base t3 where t1.activeversionid = t3.id and t3.isvalid = '1'))");
while(rs.next()){
