...
<%
    ...
    System.out.println("isselectrejectnode = "+isselectrejectnode+" ischangrejectnode="+ischangrejectnode+" nodeid="+nodeid);
    //读取配置退回节点选择配置文件
	        ...
	        <table class="ListStyle" id="oTable" cellspacing=0>
				...
				%>
				  ...
				  <%
				    ...
				    if(!nodeattribute.equals("2")&&isselectrejectnode!=2){//分叉中间节点不能重走分叉和取消合并
