...
<jsp:useBean id="rs31" class="weaver.conn.RecordSet" scope="page" />
...
rs31.executeSql("select isvalid  from workflow_base where id="+workflowid);
int isvalid = 1;
if(rs31.next()){
   isvalid = rs31.getInt("isvalid");  
}
if(!"1".equals(session.getAttribute("istest"))&&isvalid==2){
    out.print("<script> alert('流程已被修改为测试状态，请联系管理员！！！');</script>");
    return ;
}
